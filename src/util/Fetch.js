...
const API = {
    ...
    //获取媒资类型
    GetRetrieveContent:(assetId) => `<GetRetrieveContent portalId="${portalId}" client="8001002110042106" account="wxy00001"  retrieve="assetType" folderAssetId="${assetId}"/>`,
    //获取推荐栏目(海报)
...
const fetchData = (url,{ body = '',id = '', } = {},success) => {
    const _body = API[body](id);
