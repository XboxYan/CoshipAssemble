...
import FetchLive, { fetchPost } from '../InteractiveLive/FetchLive';
    ...
    getPic = () => {
        ...
        ImagePicker.showImagePicker(options, (response) => {
            if (response.didCancel) {
                ...
                const { liveUserCode, liveUserId, liveToken,userInfo:{nickName} } = Store;

                liveUserId&&fetchPost('modUser', {
                    userId: liveUserId,
            ...
            <View>
                ...
                */}
                <View style={styles.row}>
                    ...
                    <Text style={styles.rightText}>{Store.userInfo.userCode}</Text>
                </View>
