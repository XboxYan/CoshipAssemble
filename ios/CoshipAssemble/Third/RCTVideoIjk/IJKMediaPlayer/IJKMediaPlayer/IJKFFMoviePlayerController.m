...
- (id)init{
    ...
    return [self initWithContentURLString:@""
                              withOptions:options];
}
                   ...
                   withOptions:(IJKFFOptions *)options
{
    ...
    if (self) {
        ...
        //改进
//        [self setFormatOptionIntValue:10240 forKey:@"probesize"];
//        [self setFormatOptionIntValue:100 forKey:@"analyzemaxduration"];
        
        [self setPlayerOptionIntValue:0 forKey:@"no-time-adjust"];
        [self setPlayerOptionIntValue:1 forKey:@"audio_disable"];
        [self setPlayerOptionIntValue:1 forKey:@"infbuf"];
        [self setPlayerOptionIntValue:0 forKey:@"framedrop"];
        
        //videotoolbox 配置（硬件解码）
        [self setPlayerOptionIntValue:1  forKey:@"videotoolbox"];
#ifdef DEBUG
