...
#define FF_BUFFER_HINTS_PRESERVE 0x04 // UserJsonBean must not alter buffer content.
 ...
 *
 * @param cb UserJsonBean defined callback. av_lockmgr_register invokes calls
